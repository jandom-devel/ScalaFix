/**
 * Copyright 2016, 2022 Gianluca Amato <gianluca.amato@unich.it>
 *
...
class EquationSystemBench:
  ...
  val chainGraphEqs = ChainGraphEQS[Int](numUnknowns)
  val chainSimpleGraphEqs = ChainSimpleGraphEQS[Int](numUnknowns)
  val chainSimpleFiniteEqs = ChainSimpleFiniteEQS[Int](numUnknowns)
  val chainInfiniteEqs = ChainInfiniteEQS[Int]()
  val chainInfinite2Eqs = ChainInfinite2EQS[Int]()

  def validate(rho: Assignment[Int, Int]): Unit =
