...
/**
  * A mutable assignment is an assignment used for the inner working of fixpoint solvers. It also explicitly
  * keeps track of unknowns which are explicitly modified.
  *
