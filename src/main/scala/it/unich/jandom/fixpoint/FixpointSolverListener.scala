...
object FixpointSolverListener {
  ...
  object DebugListener extends FixpointSolverListener[Any, Any] {
    ...
    def initialized[U1, V1](rho: U1 => V1) { println(s"initialized with assignment ${rho}") }
    def ascendingBegins[U1, V1](rho: U1 => V1) { println(s"ascending chain begins with assignment ${rho}") }
    def descendingBegins[U1, V1](rho: U1 => V1) { println(s"descending chain begins with assignment ${rho}") }
  }
