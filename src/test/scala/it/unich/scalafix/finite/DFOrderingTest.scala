...
class DFOrderingTest extends FunSpec with PropertyChecks {
  ...
  val graph = InfluenceRelation(Seq(1 -> 3, 1 -> 2, 2 -> 3, 3 -> 4, 4 -> 6, 4 -> 5, 4 -> 8, 5 -> 7, 6 -> 7, 7 -> 4, 7 -> 8, 8 -> 4, 8 -> 3, 8 -> 10, 8 -> 9, 9 -> 1, 10 -> 7))
  ...
  val graph2 = InfluenceRelation(Seq(1 -> 2, 1 -> 3, 2 -> 3, 3 -> 4, 4 -> 6, 4 -> 5, 4 -> 8, 5 -> 7, 6 -> 7, 7 -> 4, 7 -> 8, 8 -> 4, 8 -> 3, 8 -> 9, 8 -> 10, 9 -> 1, 10 -> 7))
